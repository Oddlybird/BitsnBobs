...
// -- Maybe have an additional .java file under the Dancestry heading for that?
// -->> Or is it better in the files for each type of java object? (centralizing all data for each object in 1 place)
...
*/	
/*  overloaded version, for spritesheets
boolean Graphics.drawImage(Image img,
...
// txt file loading
	...
	public void save(String mypath, String text) {
		...
		if (mypath.equals("")) {mypath="example.txt";}
